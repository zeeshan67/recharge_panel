...
<html>
<head>
<title>Easy Recharge a  Business Corporate Category Flat Bootstrap Responsive Website Template | Payment :: w3layouts</title>
			...
			<div id="verticalTab" class="resp-vtabs" style="display: block; width: 100%; margin: 0px;">
					<div class="col-md-3 pay-left">
						<ul class="resp-tabs-list">
							...
							<li class="resp-tab-item" aria-controls="tab_item-4" role="tab">IMPS</li>
						</ul>
					</div>
